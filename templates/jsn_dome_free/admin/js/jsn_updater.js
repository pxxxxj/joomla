		...
		var jsonRequest = new Request.JSON({
			...
			onSuccess: function(jsonObj)
			{
				...
				else
				{
					if (jsonObj.redirect)
					{
						var link = url + 'index.php?template=' + template_name + '&tmpl=jsn_updaternotification&template_style_id=' + style_id + '&backup_file=' + backup_file + '&package_name=' + package_name + '&type=auto';
						window.location = link;
						return;
					}
